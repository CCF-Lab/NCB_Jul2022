...
dfx <- read.csv(file="C:\\Users\\\\OneDrive\\Desktop\\expressionmatrix.csv",row.names =1)
x <- as.matrix(dfx)
f <- read.csv("C:\\Users\\\\Desktop\\featuredata.csv",row.names =1)
p <- read.csv("C:\\Users\\\\OneDrive\\Desktop\\microarrayphenotype.csv",row.names =1)
...
normal <- exprs(eset_norm)
write.csv(normal,"C:\\Users\\joelc\\OneDrive\\Desktop\\normalmicroarray.csv")
